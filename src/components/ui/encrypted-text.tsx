...
type EncryptedTextProps = {
    ...
    continuous?: boolean;
    /** Time in ms to pause after full reveal before restarting (for continuous mode) */
    pauseMs?: number;
};
...
export const EncryptedText: React.FC<EncryptedTextProps> = ({
    ...
    }, [isInView, text, revealDelayMs, charset, flipDelayMs, continuous, pauseMs, resetAnimation]);
